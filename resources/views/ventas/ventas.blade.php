            ...
            <tbody>
                ...
                <tr class="fradeX odd">
                    ...
                    <td style="display: none;">
                        ...
                        <button class="id" id='Modificar' onclick="clickaction(this)" value="{{$item->Folio}}"><img src="plugins/bootstrap-icons/icons/pencil-fill.svg"/></button>
                        <button class="id" id='Modificar' onclick="clickdelete(this)" value="{{$item->Folio}}"><img src="plugins/bootstrap-icons/icons/trash-fill.svg"/></button>
